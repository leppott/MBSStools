...
Updated in 2024 to replace the `rgdal` package (deprecated in 2023) with the
`sf` package.
...
The intent behind this function was to recreate the fish taxa distribution maps
on the DNR website.  The data inputs are not specific to fish and can be used
for benthic macroinvertebrate data.
