...
* fix: Add na.rm = TRUE to all dplyr sum and n_distinct calls in `metric.values`, Issue #94
...
* refactor: Update vignette for IBI calculations, Issue #45
    + StringAsFactors default now FALSE so don't have to remove in Vignette
