...
#'
#' @details The Shiny app based on the R package MBSStools is included in the R package.
...
runShiny <- function(){##FUNCTION.START
  ...
  #
  if (appDir == "") {
    stop("Could not find example directory. Try re-installing `MBSStools`.", call. = FALSE)
  }
  #
