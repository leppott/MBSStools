...
A background file (/data-raw/metrics.scoring.tab) is included and provides a table with the metric names and scoring thresholds for each IBI and index region.  By default, this table is populated with the appropriate values for the MBSS IBIs.  This table can be modified.  
